...
"[Design by Contract](https://www.eiffel.com/values/design-by-contract/)" is a trademark. It is an analogy used by Eiffel. If one piece of code uses another piece of code, then we can think of this situation as contract between a client and a supplier. The following text is from [The Power of Design by Contract™](https://www.eiffel.com/values/design-by-contract/):
